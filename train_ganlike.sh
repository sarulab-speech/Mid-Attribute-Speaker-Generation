dir_path="config/JVS-VCTK_langemb_ganlike_configs/*"
...
for dir in ${dirs[@]}; do
    echo $dir
    python train_ganlike.py -c $dir --use_clf --checkpoint output/ckpt/JVS-VCTK_pretrain/20000.pth.tar --corpus JVS VCTK
    echo -e "\n train done! \n"
